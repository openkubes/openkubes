#!/usr/bin/env python3
"""Generate the immutable, non-authorizing OK-141 fresh-run v2 package."""
...
RUNNER_SOURCE_SHA = "5a186bef100b79a7fb84221800443e4a58001945"
...
def build_enablement() -> tuple[dict, str, str]:
    ...
    annotations.update({
        "openkubes.io/candidate-status": "fresh-run-v2-no-go",
...
def build_registration() -> list[dict]:
    ...
    project["spec"]["description"] = "Fresh-run-v2 OK-141 P9 AppProject"
...
def main() -> None:
    ...
    manifest = {
        "format": "ok141-fresh-run-package/v2",
        "authorizationState": "NO-GO",
