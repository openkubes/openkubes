#!/usr/bin/env python3
"""Derive the non-authorizing Stage-1 signing candidate from fresh-run-v1."""
...
PACKAGE = HERE.parent / "fresh-run-v1"
...
def main() -> None:
    ...
    candidate = {
        "format": "ok141-fresh-stage-authorization-candidate/v1",
