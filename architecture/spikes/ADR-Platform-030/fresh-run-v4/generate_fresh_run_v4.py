...
RUNNER_SOURCE_SHA = "cdcb0c83d65bb359c27b80915351ecee3efd24f6"
...
def build_enablement() -> tuple[dict, str, str]:
    ...
    annotations.update({
        "openkubes.io/candidate-status": "fresh-run-v4-no-go",
...
def build_registration() -> list[dict]:
    ...
    project["spec"]["description"] = "Fresh-run-v4 OK-141 P9 AppProject"
...
def main() -> None:
    ...
    manifest = {
        "format": "ok141-fresh-run-package/v4",
        "authorizationState": "NO-GO",
