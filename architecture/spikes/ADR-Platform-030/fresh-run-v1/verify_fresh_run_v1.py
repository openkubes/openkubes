#!/usr/bin/env python3
"""Fail-closed offline verification for the OK-141 fresh-run package."""
...
import generate_fresh_run_v1 as generator
...
def verify(root: Path) -> str:
    ...
    expect(manifest["format"], "ok141-fresh-run-package/v1", "package format")
