...
RUNNER_SOURCE_SHA = "cd180dd8127de82973295ee9913ad549e9331a33"
...
def build_enablement() -> tuple[dict, str, str]:
    ...
    annotations.update({
        "openkubes.io/candidate-status": "fresh-run-v5-no-go",
...
def build_registration() -> list[dict]:
    ...
    project["spec"]["description"] = "Fresh-run-v5 OK-141 P9 AppProject"
...
def main() -> None:
    ...
    manifest = {
        "format": "ok141-fresh-run-package/v5",
        "authorizationState": "NO-GO",
