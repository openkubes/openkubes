...
DIGEST = HERE / "go1-l-submitter-candidate-v2.sha256"
SPEC = importlib.util.spec_from_file_location("ok141_go1_l_submitter_v2_verify", HERE / "bounded_go1_l_submitter_v2.py")
