...
from verify_m0a_v3_risk_acceptance import VerificationError, verify  # noqa: E402


EVIDENCE = ROOT / "m0a-v3-risk-acceptance-v1.yaml"
DIGEST = ROOT / "m0a-v3-risk-acceptance-v1.sha256"
