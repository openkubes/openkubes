...
from verify_m0a_first_run import VerificationError, verify  # noqa: E402


EVIDENCE = ROOT / "m0a-first-run-evidence-v1.yaml"
DIGEST = ROOT / "m0a-first-run-evidence-v1.sha256"
...
def write_fixture(tmp_path: Path, document: dict) -> Path:
    path = tmp_path / "m0a-first-run-evidence-v1.yaml"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("spec", "credential", "immediateTokenRejectionProbe", "result"), "PASS"),
    ],
)
