#!/usr/bin/env python3
"""Fail-closed offline verification for the OK-141 fresh-run v2 package."""
...
import generate_fresh_run_v3 as generator
...
def verify(root: Path) -> str:
    ...
    expect(manifest["format"], "ok141-fresh-run-package/v3", "package format")
