...
5. **Remaining, and the only open item:** set `Status: Accepted — three-way review (Arash / Claude / GPT, 2026-07-25)` and merge. Reserved for a human reviewer, not the evidence producer.
