...
#: Cross-repository compatibility contract for
#: ``ok-cluster/ok-kagent/kagent/access-config.yaml``.  That consumer selects
#: from this table; changing either side requires running the consumer's
#: ``make access-test OPENKUBES_DIR=<this checkout>`` before merge.  PR #27 was
#: once merged while the supplying openkubes PR #50 was only closed, which left
